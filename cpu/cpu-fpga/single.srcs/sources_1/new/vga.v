...
module vga (
           input clk,                 // 65MHz 
           input [11: 0] vdata,       // RRRRGGGGBBBB
           
           output [11:0] vaddr_x,
           output [10:0] vaddr_y,
           
           output reg h_sync, v_sync,
           output reg [11:0] vga      // RRRRGGGGBBBB
       );
  ...
  localparam h_total_pixels = (h_active_pixels + h_front_porch + h_back_porch + h_sync_width);

  localparam v_active_pixels = 768 ;
  localparam v_front_porch = 3 ;
  localparam v_sync_width = 6 ;
  localparam v_back_porch = 29 ;
  localparam v_total_pixels = (v_active_pixels + v_front_porch + v_back_porch + v_sync_width);
